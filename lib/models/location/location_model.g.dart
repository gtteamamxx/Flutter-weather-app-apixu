...
class _$LocationModelSerializer implements StructuredSerializer<LocationModel> {
  ...
  @override
  Iterable serialize(Serializers serializers, LocationModel object,
  ...
  @override
  LocationModel deserialize(Serializers serializers, Iterable serialized,
      {FullType specifiedType = FullType.unspecified}) {
...
class _$LocationModel extends LocationModel {
  ...
  factory _$LocationModel([void updates(LocationModelBuilder b)]) =>
  ...
  @override
  LocationModel rebuild(void updates(LocationModelBuilder b)) =>
...
class LocationModelBuilder
  ...
  @override
  void update(void updates(LocationModelBuilder b)) {
