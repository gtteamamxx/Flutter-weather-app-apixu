...
void dashboardForecastPageMiddleware(
...
_fetchForecastWeather(Store<AppState> store, FetchForecastWeatherAction action,
    NextDispatcher next) async {
  next(RequestForecastWeatherAction());

  try {
    WeatherApi weatherApi = serviceLocator.get<WeatherApi>();
    ForecastRootBaseModel forecastModel =
        await weatherApi.fetchForecastWeather(action.cityName, daysNumber: 10);
